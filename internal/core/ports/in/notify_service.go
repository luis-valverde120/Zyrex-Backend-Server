...
type NotifyService interface {
	...
	CreateNotification(notification *models.Notification) (*models.Notification, error) // Create a new notification
	GetNotificationByIDOwner(id int) (*models.Notification, error)                      // Get a notification by ID for the owner
	GetNotificationByIDClient(id int) (*models.Notification, error)                     // Get a notification by ID for the client
